  ...
  Meteor.publish("clientssummary", function () {
    ...
    if (ClientsSummary.find().count() === 0) {
      ...
      Meteor.setInterval(function(){
                      ...
                      ClientsSummary.update({_id : '1'}, {$set : {current : currentUsers, currentLogged : activeLoggedUsers, totalLoggedUsers : totalLoggedUsers, total : totalClients, recordClients : recordClients}});
