if (Meteor.isServer) {
  ...
  Meteor.publish("clientssummary", function () {
    ...
    if (ClientsSummary.find().count() === 0) {
      ...
      ClientsSummary.insert({_id: 'summaryId1234', activeLoggedUsers :0, totalLoggedUsers: 0, recordClients: 0, signedupUsers: 0, totalSpeakersLogged: 0, totalRegistered: 0, activeLastHour : 0});
    }
